        ...
        <tr>
          <td align="center">
            <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #FFFFFF; border-radius: 20px; padding: 40px; box-shadow: 0 4px 24px -4px rgba(222, 44, 78, 0.12);">
              ...
              <tr>
                 <td align="center" style="padding-bottom: 30px;">
                    <a href="${frontendUrl}/email-verification?code=${code}&email=${email}" target="_blank" style="background-color: #DE2C4E; color: #FFFFFF; padding: 14px 32px; border-radius: 12px; text-decoration: none; font-weight: bold; display: inline-block; font-size: 16px;">
                      Підтвердити пошту
                    </a>
                 </td>
              </tr>
